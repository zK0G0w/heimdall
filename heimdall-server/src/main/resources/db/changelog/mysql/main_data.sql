...
(6, 'SITE', '系统LOGO', 'SITE_LOGO', NULL, '/logo.png', '显示在登录页面和系统导航栏的网站图标（建议 .svg 格式）'),
...
VALUES
(1, '开发环境', 'local_dev', 1, NULL, NULL, NULL, 'C:/heimdall/data/file/', 'http://localhost:8000/file/', b'1', '.RECYCLE.BIN/', '本地存储', b'1', 1, 1, 1, NOW()),
(2, '生产环境', 'local_prod', 1, NULL, NULL, NULL, '../data/file/', 'http://api.your-domain.com/file/', b'1', '.RECYCLE.BIN/', '本地存储', b'0', 2, 2, 1, NOW());
